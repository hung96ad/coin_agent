...
class User extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = 'CPPTS : Dashboard';
        
        $this->loadViews("userListing", $this->global, NULL , NULL);
    }
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'CPPTS : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'CPPTS : Add New User';
...
//    }
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'CPPTS : Edit User';
    ...
    {
        $this->global['pageTitle'] = 'CPPTS : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'CPPTS : User Login History';
    ...
    function profile($active = "details")
    {
        ...
        $data["active"] = $active;
        $this->global['pageTitle'] = $active == "details" ? 'CPPTS : My Profile' : 'CPPTS : Change Password';
